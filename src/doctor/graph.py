...
def run_diagnosis(
    ...
    *,
    ...
    rec = RunRecord(
        ...
        tokens_in=client.stats.tokens_in,
        tokens_out=client.stats.tokens_out,
        tokens_in_saved=client.stats.tokens_in_saved,
        tokens_out_saved=client.stats.tokens_out_saved,
        llm_cost_inr_saved=round(client.stats.cost_inr_saved, 4),
